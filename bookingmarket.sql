...
--
-- Host: localhost:3300
-- Generation Time: Apr 06, 2019 at 08:07 PM
...
INSERT INTO `users` (`id`, `name`, `userName`, `email`, `location`, `language`, `bio`, `paymentInfo`, `billingInfo`, `image`, `country`, `phone`, `userType`, `isActive`, `email_verified_at`, `password`, `activation_token`, `created_at`, `updated_at`) VALUES
(1, 'Nazmul Chowdhury', 'nazmul', 'nazmul@ymail.com', 'Sylhet', 'volvo', 'sss', 'sss', 'ss', '/uploads/TR0fQprwrOD4tjEojSHPcdKUNNf6WgLEp3GB9pys.jpeg', 'ss', 'sss', 4, 1, NULL, '$2y$10$9gGLCtY83JzC7NovcNUnyuRDWdzY/l1vM1ATq.NfeiCQmXBfxErpS', '8oCfxpYEK9GySG43NwPJSoNcVrmsglRY5JRMjS7oXiutOuSZdooc05jnn6vL', '2019-03-10 05:38:59', '2019-03-30 11:35:16'),
(2, 'Kamran Ahmed', 'Kamran', 'iamkamran@gmail.com', 'Sylhet', 'English', NULL, NULL, NULL, '/img/prfile.png', 'Bangladesh', '01681189844', 1, 1, NULL, '$2y$10$kfhkpdNwJln.UNiZRRn1V.4B6FGxiFzpUHhJhxWFG0ZR7jHtYyLiW', 'ifTSVgSP4CoJGkyJESZl6eWnlMcnjvYDxkbUB7JUWSWdQTFhgn7uxGpoLTVc', '2019-03-11 01:45:27', '2019-04-06 12:39:21'),
(3, 'Sadek Ahmed', 'sadek', 'iamsadek@gmail.com', 'Sylhet', 'volvo', 'Ami Boss Boss Boss.. Kita mato .Bolda hokol... Kamran boro Bolda', NULL, NULL, '/uploads/pUkAHn2vOW4LgOPSMOvpqvYmkYFzaevYHSFgMXAN.jpeg', NULL, NULL, 1, 1, NULL, '$2y$10$9gGLCtY83JzC7NovcNUnyuRDWdzY/l1vM1ATq.NfeiCQmXBfxErpS', NULL, '2019-03-12 05:24:39', '2019-04-06 13:06:26'),
(4, 'Numan Shipu 1', 'numan', 'numan@gmail.com', 'sylhet', 'volvo', 'this is my bio', 'no payment info', 'no billing info', '/img/prfile.png', 'New Zealand', '+641239190432', 1, 1, NULL, '$2y$10$9gGLCtY83JzC7NovcNUnyuRDWdzY/l1vM1ATq.NfeiCQmXBfxErpS', NULL, '2019-03-15 06:56:42', '2019-04-06 12:53:29');

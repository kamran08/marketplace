			...
			<div class="_1search_section_main">
				...
				<div class="_1search_section_search">
					...
					<div class="_1search_section_search_button">
						<button class="_1search_section_search_button_btn _bg" name="s" type="button" @click="showdata">SEARCH NOW</button>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="find_title">
					...
					<div class="find_row _flex_row" >
						<div class="find_all find_left" v-for="(item,i) in alljobs" :key="i">
		...
		<div class="jobs">
			<div class="container">
				...
				<div class="job_row row">
						<!-- items -->
					<div class="col-6 col-md-3 job_all" v-for="(service,i) in allService" :key="i">
